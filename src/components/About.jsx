  ...
  return (
    ...
    >
      <Container maxWidth="lg">
        <Typography variant="h4" component="h1" gutterBottom align="center" sx={{ color: '#4caf50' ,fontFamily:'Open Sans'}}>
          About Us
        </Typography>
        <Grid container spacing={4}>
          <Grid item xs={12} md={6}>
            <Paper elevation={3} sx={{ p: 3, bgcolor: '#f1f8e9' }}>
              <Typography variant="h6" component="h2" gutterBottom sx={{fontFamily:'Open Sans',fontWeight:'bold'}} >
                Our Mission
              </Typography>
          ...
          <Grid item xs={12}>
            <Paper elevation={3} sx={{ p: 3, bgcolor: '#f1f8e9' }}>
              ...
              <Typography variant="body1" sx={{fontFamily:'Open Sans'}}>
              Discover the future of urban mobility with @e auto Electric Autos. Our mission is to revolutionize transportation, offering eco-friendly, affordable, and convenient solutions for city dwellers. Powered by cutting-edge technology and sustainability, our electric autos provide a clean and efficient alternative to traditional petrol vehicles. Embrace convenience without compromising the environment, as we pave the way towards a greener tomorrow. Join us in our journey towards cleaner, smarter, and more accessible transportation options for all, as we strive to make every ride a sustainable and enjoyable experience.
              </Typography>
            </Paper> 
          </Grid>
        </Grid>
